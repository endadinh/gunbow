                    ...
                    <div className="container mt-5">
                        <div className="col-12 text-center">
                            <div className="card-title">
                                <h2>{i18next.t('account').airdrop}</h2>
                            </div>
                        </div>
                        <FilterBox
                                                ...
                                                <div className="card ">
                                                    ...
                                                    <div className="card-caption col-12 p-0">
                                                        ...
                                                        <div className="card-body text-center">
                                                            ...
                                                            <Link to={`/sell-items/${item.id}`} className="btn btn-bordered-buy btn-smaller mt-3" ><i className="fas fa-shopping-cart mr-2" />{i18next.t('_sell_item')}</Link>

                                                            <button className="btn btn-bordered-buy btn-smaller mt-3" onClick={() => { this.openAirdrop() }} ><i className="fas fa-box-open mr-2" />{i18next.t('_open')}</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
